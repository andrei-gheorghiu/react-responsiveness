...
const f = {
  ...
  w = p((s) => {
    var o;
    return (
      ((o = Object.entries(s(h)).find(([, m]) =>
        m == null ? void 0 : m.only
      )) == null
        ? void 0
        : o[0]) || ""
    );
          ...
          Object.entries(t).forEach(([e, n]) => {
            ...
            Object.entries(x).forEach(([i, a]) => {
              const r = ({ matches: c }) => {
                o((d) => {
                  var b;
                  if (((b = d[e]) == null ? void 0 : b[i]) === c) return d;
                  const { min: g, max: _ } = {
                    ...d[e],
                    [i]: c,
                  };
...
export { f as Presets, B as useReactResponsiveness };
